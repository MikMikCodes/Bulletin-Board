...
//styling the stored note 
    node1.setAttribute("style", "width:250px; height: 250px; font-size: 18px; padding: 25px; margin-top: 10px; overflow: hidden; box-shadow: 0px 10px 24px 0px rgba(0,0,0,0.75);");
